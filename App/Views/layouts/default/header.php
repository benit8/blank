...
<html>
	<head>
		...
		<link rel="stylesheet" href="/styles/bs-overrides.less">
		<link rel="stylesheet" href="/styles/main.less">
		<?php foreach ($styles as $s) echo '<link rel="stylesheet/less" href="' . $s . '">'; ?>
	...
	<body>
		<nav class="navbar navbar-expand-md navbar-dark bg-dark">
			...
			<div id="global-flash-container"><?php \Core\Session::dumpGlobalFlash(); ?></div>
